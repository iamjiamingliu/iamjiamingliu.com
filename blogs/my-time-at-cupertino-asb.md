---
title: My Time at Cupertino ASB, and TNT
description: I poured my heart and soul into them. I don't know why.
tags: [ Lore ]
category: Life
created_at: 2026-03-20 23:15:57
updated_at: 2026-03-20 23:15:57
excludes_from_index: True
---

## Foreword

As I said in my blog's overview paragraph,
...
So, here's something that happened a while ago that mattered to me a lot.
...
you would go up to the podium, introduce your proposal, and get bombarded with a billion "_it's great, but..._"
...
It was a place where many hours of the best years of my teenage days went;
teenage days are precious, so the place where you spent a lot of your teenage days is thus precious.
It was a place that fueled so much of my growth in leadership and innovation.
It was I place I called home.

So, let me write my ASB lore down before I eventually forget it all.
There's not that many precious memories one would be able to have,
so you gotta hang on tight to your memories.

My lore with Cupertino ASB intersected with my journey of founding Tino News Today (TNT),
the beloved newscast program that everyone watches at CHS nowadays.
...
My family just moved from Maryland to California by loading all of our belongings into our Toyota Camry
and driving it across the country.
For whatever reason, whether you call it ego or self-drive,
I was determined to do something big and make a hit at Cupertino High School.

The middle school I went to in Maryland, Robert Frost Middle School,
had a TV newscast program where kids would anchor the show to broadcast announcement bulletins, worldwide news, and other types of content.
I figured that CHS didn't have something like that.
If it worked in Robert Frost, surely it would work at CHS.
CHS did have morning announcements though, but it was purely audio via the PA speakers.

So, on the 3rd day of my arrival at CHS,
I went to the ASB teacher (ASB runs the morning announcements) and told him about my idea to make video announcements.

And of course he said no.

## My Failed Club Application

I didn't give up my plan to make something big yet.
As a confused freshman figuring out what to do,
I sat in a couple club meetings and became over-confidently determined that,
every CHS club in existence was too boring: they are nothing but Google Slides presentations.
I especially remembered the FBLA (business club) new member recruitment presentation:
the presenter's voice was monotone, the audience was scrolling their phones, and the Google slide never seemed to end.

So I tried to create a club that's actually fun.
How about, a Minecraft Club?
People loved playing Minecraft.
The irony was: I don't even play Minecraft.
Nowadays, whenever I try a new initiative,
I would make extra sure I first have the qualifications to make that initiative happen.
But the high school freshman version of myself was too ignorant to realize the importance of having qualifications.
So, I applied with ASB to form a new Minecraft Club.

Of course ASB rejected my Minecraft Club,
rejected by the same teacher who rejected my video announcements proposal,
as well as the three ASB Club Commissioners who are like the overlords of everything club-related at CHS.

One of the ASB Club Commissioner was actually the President of FBLA whose presentation I sat in a week ago;
he was also the President of Tinovation (largest CS club at CHS).
It's funny, because I basically followed his footsteps:
I later became an ASB Clubs Commissioner as well, served as Executive Officer for Tinovation as well,
and now, guess is going to OpenAI as well? 😂
Small world.
Mr. Predecessor, If you are reading this, I just want to say,
I'm sorry you saw the foolish, ignorant version of me, I'm all practical and humble now 😭.

## My Failed Election

Well, video announcements didn't work, founding Minecraft club didn't work,
maybe I can try running for ASB student council next.
After all, I gotta keep on trying.

So, I ran for the lowest position in the student council: rally chair.
But apparently many others thought that running for a lower position might be easier to get in,
which it turned out not: rally chair became the most contested position with 6 candidates, whereas the top roles like President only had 1 or 2.
Obviously, for someone who just drove all the way from Maryland to California,
with no friends and popularity, I lost the election.

## Giving Up

I really felt like giving up. I felt that every door was closed to me.
In hindsight, I was simply too pompous to be able to get anywhere.
You need to be humble and down-to-earth to start at the bottom and work it up.

Nevertheless, I gave another shot to Minecraft Club.
The ASB Teacher told me that, there's already a gaming club on campus.
So, from his suggestion, I asked the gaming club officer if I can start a Minecraft division under gaming club,
so that I can carry out my Minecraft events as planned.

Gaming Club officers said yes, so Minecraft Division hosted its grand opening,
attracted 120 attendance in its first meeting (the largest club meeting ever recorded),
but within weeks, Minecraft died down to only 10 routine participants;
then I ran into huge ideological fights with Gaming Club officers on Discord,
got the ASB Teacher and Assistant Principal involved in the squabble,
and ASB disbanded the Minecraft Division and froze Gaming Club for 1 semester as punishment.

I gave up.

## COVID, Reading, and Learning

Then COVID came.
As everything around my life changed around the virus and quarantine,
all of a sudden, I wasn't too distressed about my failures with video announcements, Minecraft, or ASB much more.

I forgot who told me to do this, but I started reading biographies of famous people like crazy.
Steve Jobs, Benjamin Franklin, Dwight Eisenhower, Henry Kissinger, to name a few.
I barely remembered the details of the plots,
but the images of great men with courage, self-drive, innovation, and integrity became deeply imprinted in my head,
and I wish I could be like them one day.

I also picked up the habit of reading leadership books.
I started with the infamous, and very-much "self-help" ish book _48 Laws of Power_,
which from my experience I later concluded that real leadership must do everything the opposite of what _48 Laws of Power_ advocated,
because _48 Laws of Power_ is simply too Machiavellian.
Then I read the good books, from the legendary UCLA Basketball Coach John Wooden's _Wooden On Leadership_ to _How Google Works_ by its ex-CEO Eric Schmidt.
These books shaped my style and belief in leadership, which is:
**always be kind and fair, and be strict in necessary times; lead, empower, and innovate.**

During COVID, I also found my passion for coding. See [My Tech Growth](/blogs/my-tech-growth.md) for more.

The wisdoms I gained from the biographies and leadership books became critical
to the founding of Tino News Today,
and they have continued to power my leadership endeavors to this day.
Since then,  I've read even more books, applied them in more endeavors, corrected my belief from errors,
and continued to practice this feedback loop.

## Preparing for TNT, Again

I _really_ thought I should shoot another shot at Tino News Today.
After all, newscasting worked in my Maryland middle school so well,
there's no reason it won't work at CHS.
Audio announcements at CHS have proven to be ineffective,
and it is intuitive to try video newscasting instead because it would be a lot more engaging.

My first attempt to pitch TNT on my 3rd day of school failed because I was ill prepared.
I had a vision, but I had not thought about how to implement the vision at all.
I didn't think about what exactly should each episode contain,
how the production workflow for the episodes would be orchestrated,
...
These Google Docs are still in my Google Drive account to this day,
and they continued to remind me of the once ignorant, but always driven, and evenutally matured me.
...
Nevertheless, I determined to try it again when the opportunity comes.
I did not want to surrender myself to mediocrity yet.

## My Successful Club Application, Kind Of

While I was reading and preparing for the comback of TNT in Sophomore year,
a friend of mine approached me to help him Co-Found a Table Tennis club with ASB.
The club would be functional after quarantine, he argued.
He lacked experience navigating the ASB paperworks,
and since I battled ASB with Minecraft Club / Division,
he invited me to Co-Found the Table Tennis Club so that I can help navigate the application paperwork.
...
I knew the chance were slim, but the downside is small and the upside is great.
The ignorant young me didn't care if my reputation and relationship with ASB had already been ruined earlier with TNT or Minecraft.
So he filled out the application, I gave some advice along the way,
and I was shocked and happy when I saw that ASB actually approved our Table Tennis Club.

That was the first time in high school that I succeeded in something;
even though I was a secondary character in contribution.
It was a great boost to my confidence and self-drive,
especially as I thought earlier that all the doors were closed to me.

Later on, I served as VP to Table Tennis Club,
helped to host the weekly practice events, secured our own table,
and actually started playing table tennis.
Fake it until you make it I guess
(I heavily despise this principle now, but when you are bootstrapping yourself from nowhere, I guess it's somewhat understandable).
And, the President of Table Tennis Club went on to become the President of FBLA. Small world.

## Becoming One Of You

Towards the end of Sophomore year,
I got a sent-to-everyone email in my school inbox about applying for ASB Commissioners.
...
I dropped my resume.
And, out of
to apply to be a — how dare I — Club Commissioner.
...
Suppose I stayed as a super-senior at CHS and continue to steer TNT for years to come,
I would pursue the following strategic themes for TNT:

| Name                                                   | Description                                                                                                                                                                                                                                         | Impact                                              | Effort                                                                                                                      | Risks                                                             | Longevity                                                                                                                   |
|--------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|
| Expanding TNT original content                         | TNT always deserves more content beyond the daily bulletins. People love seeing their peers up there doing whatever funny things they are doing. There's mad potential to introduce more entertainment, non-bulletin related content to TNT         | High, because people will love to watch it          | High, because handling multiple creative processes is hard                                                                  | Low, because there's no cost                                      | Medium. It's a lot of effort, but if you keep the routine types of content, it can still be engaging after a while          |
| Increasing stage quality                               | The anchor table and background behind the anchor can be a lot better quality than some cheap poster paper                                                                                                                                          | Medium, because people will instantly notice it     | Once, and then use it forever                                                                                               | Low, it's just the materials needed to make a better anchor stage | Long. You can use it forever, kind of                                                                                       |
| Increasing video editing quality                       | The sound design, text design, editing cuts... things can always be taken to the next level                                                                                                                                                         | Medium, because it's an improvement, not innovation | High. We are a bunch of high schoolers, we are not professional video editors.                                              | Low. It's just making the editing better.                         | Low. Because it's hard to keep a group of high schoolers without adult supervision to always be editing high quality videos |
| Growing TNT's distribution beyond teachers' projectors | We need to have our own Instagram content. It will not only be another distribution of the content, but furthermore, it would be an unique opportunity to create bi-directional engagement with the audience and produce Instagram exlusive content | High, because everyone doom scrolls Instagram       | Medium if it just means another distribution channel. High if it means exlusive content and audience engagement are planned | Medium. Because it's kind of something completely new             | High, because Instagram pages are hard to die                                                                               |

In reality, now that I've been long gone from TNT, here's what actually happened:

- Expanding TNT original content: shrinked actually, because it's high effort
- Increasing stage quality: attempted twice, each time did increase the stage design quality somewhat
- Increasing video editing quality: gone down somewhat, because it's high effort to edit good videos
- Growing TNT's distribution beyond teachers' projectors: attempted to create TNT instagram page, but plan was aborted for unknown reasons
...
really should have been, "My Time at Cupertino High School, Everything Except the Tech Part".
ASB, TNT, and the tech stuff were the pillars of my time at CHS.
As what I wrote on my Student of the Year poster,
...
When I just started UCSB,
I frequently brought up my story with ASB or TNT to my friends in college,
and that earned me the name "Peaked in High School" Jiaming.
So, I intentionally avoided talking about my CHS time anymore in front of friends.

But alas, as I said in the opening paragraph of this article,
there's not that many precious memories one would be able to have,
so you gotta hold on to your memories.
I am about to go into the workforce,
hopefully with all the PRs, code reviews, performance reviews, salary and stress,
I can still retain the happy memory of the younger me.

My time with ASB and TNT is a piece of memory I will continue to hold on dearly,
for it was quite a journey with tears, failures, success, and growth.
